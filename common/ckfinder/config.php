<?php
	session_start();
	require_once(dirname(dirname(dirname(dirname(dirname(dirname($_SERVER['SCRIPT_FILENAME'])))))).'/site_settings.php');

/*
 * ### CKFinder : Configuration File - Basic Instructions v2.2.1
 *
...
{
	return isset($_SESSION[ADMIN_SITE]['uid']);
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'KanaiTek, Inc.';
$config['LicenseKey'] = 'U2Q8-9UU7-U7D3-EYYU-9UUU-W4BQ-7DYB';
...
*/
$baseUrl = PUBLIC_URL."/page-images/";
...
ATTENTION: The trailing slash is required.
*/
$baseDir = PUBLIC_PATH."/page-images/";
